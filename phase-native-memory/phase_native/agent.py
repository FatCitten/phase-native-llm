...
are absent the identical tool surface is exercised offline by driver.ScriptedDriver, and this
file is ready to run wherever creds exist (install the [live] extra).
...
def run_agent(
    ...
    if client is None:  # only import the SDK when we actually construct the default client
        import anthropic
